...
/*******************************************************************************
   Populate Tables
********************************************************************************/
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (1, 'Sara Dias', 'saradias', 'sarinhadias2004@gmail.com', 937856499, "Rua Padre Francisco Rangel 63","4250-156", "Porto", "$2y$12$xdR1xYTlpN2aJ0OOX6PNfuTPVH2iS7.R7.MgNO5NXIEADtVXqarPW"); ---sara2004
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (2, 'Luís Lima', 'lluislima', 'luis23lima@hotmail.com', 966567899, "Rua da Esperanca 21", "9760-100", "Lisboa", "$2y$12$dORBUHSEUA/DDj3Wf4BBnuevNHqtyZEWRD3FTleN23QUgmTjvV5Pi");---informatica2020
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (3, 'Maria Azevedo', 'mariaa12', 'mariazevedo@hotmail.com', 934746528, "R. de Gonçalo Sampaio 243", "4150-367", "Porto", "$2y$12$ftM6hSNlXnGHkyeMdjDvnOBpDlrb83yaEFxbG6tbrFGSmnNG6hpP.");---123456789
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (4, 'David Soares', 'dav_soares', 'soaresdavid@gmail.com', 935665584, "R. de Montebelo 97B", "4150-131", "Porto", "$2y$12$/AxbyH.xYttAom3xig.jH.J/lGAgMWudq0gzP8UkYf5sEsSmFOD6W"); ---mysecretpassword
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (5, 'Nicole Oliveira', 'nicoleolive', 'nicoleeoli@outlook.pt', 951554887, "Rua de Santos Pousada 673", "4000-156", "Porto", "$2y$12$8CYbmrcYlnMF3b3jCkJTp.TiwWue9c2PIZPiW4.aid74PQ3.o38ka"); ---oBoticario
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (6, 'Filipe Pereira', 'fpereira', 'filipereira71@gmail.com' , 937441147, "Tv. de Cedofeita 24", "4050-448", "Porto", "$2y$12$ZMs1.1AYr7edn6BW24TDvuV/teusSxdbm5Sf69mq/5lMPPYiNTVA2");---starwars
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (7, 'Rui Sousa', 'ruisousa4', 'ruisousa4@hotmail.com', 922357445, "Canada da Vista 15", "9760-110", "Almada", "$2y$12$FlMisJUhHj3czUs5EuQIuOEqqwL0wkG3pfsC2nwxykyci5zj.zExe");---nopasswordrequired
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (8, 'Rute Martins', 'rute5martins', 'rutemartins5@outlook.pt', 912778963, "Rua Carlos Manuel 23", "4200-156", "Porto", "$2y$12$uOQJMZN.QsYs7j/Hc7EAHenCfM6N1bqyVSB0N7f7n5M1M7TgdheMW");---error404   
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (9, 'Henrique Costa', 'henricosta45', 'costahenrique@gmail.com' , 925446778, "Tv. de Lima 55", "4200-205", "Coimbra", "$2y$12$r7/7MZDxwfvvqWp9yHeJyef35qPsrYKZoLtNEMDMQx9Zp4UhB0TKq");---ltw21-22
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (10, 'Bruna Vaz', 'brunaavazz1', 'bruna1vaz@hotmail.com', 913456654, "Canada do Saco 36", "9760-456", "Almada", "$2y$12$6oAdF7p5bU/o9WwtlWOtQOM9fuhz5BscFGh5GA7DzTiXyimo33dv2");---safemodeon
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (11, 'Cláudio Ornelas', 'ornelasclaudio', 'ornelasclaudio@outlook.pt', 934998789, "Rua de Baixo 42", "4000-894", "Aveiro", "$2y$12$Mh7wfjQdeWr4.6YJlKETzOBuz90ttta6h1yWdV2ha5P0AnPEdoTqu");---benfica1904
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (12, 'Nuno Amaro', 'nunoamaro13', 'nunoamaro13@gmail.com' , 919789369, "Tv. de Sao Cristovao 1", "4050-101", "Porto", "$2y$12$VgCzZ4m2uS4ehn5yt03.quAGNudgt3goTBx8Wyoov7HLEGbB2Dtna");---DontEvenTry2Hack!
INSERT INTO User(idUser, name, username, email, phoneNum, address, zipCode, city, password) VALUES (13, 'Andreia Silva', 'dreiasilva', 'andreiasilava08@gmail.com', 934518743, "Rua das Andresas 306", "4100-051", "Porto","$2y$12$JiuEanVEoFD3xcptxHF4hOAdCDOQJhdKy.4KQcalWinrtRQkerqGO");---whatpassword
